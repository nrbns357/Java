...
public class Sprint100 {
	...
	private final String name;
		...
		public void run() {
			...
			while (true) {
				...
				System.out.printf("%s 선수가 %d 초 동안 %2.f를 달렸습니다.\n", name, times, distance);
	...
	public void play() {
		Athlete usainBolt = new Athlete("우사인 볼트", 9.58);
		Athlete kim = new Athlete("김국영", 10.07);
		Athlete fastStudent = new Athlete("빠른 학생", 12.34);
		Athlete slowStudent = new Athlete("느린 학생", 19.44);
